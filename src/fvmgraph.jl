...
struct FVMGraph
    ...
    #  |--|-----|-----|-----|-----|-----|-----|-----|--|
        ...
        bnodefac[1]=1
        bnodefac[2]=1
        new(1,n,2,nodes,edges,efac,nfac,bnodes,bregions,bnodefac)
    end

    # Constructor for 2D discrete geometry
    function FVMGraph(X::Array{Float64,1},Y::Array{Float64,1})
    #  Primal Grid:
    #  o-----o-----o-----o-----o-----o-----o-----o-----o
    # Dual grid with control volumes
    #  |--|-----|-----|-----|-----|-----|-----|-----|--|
        ...
        new(2,n,4,nodes,edges,efac,nfac,bnodes,bregions,bnodefac)
    end
